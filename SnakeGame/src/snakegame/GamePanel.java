...
public class GamePanel extends JPanel implements ActionListener{
  ...
  static final int GAME_UNITS = (SCREEN_WIDTH*SCREEN_HEIGHT)/UNIT_SIZE;  //calculates number of objects can be fitted in screen
  static final int DELAY = 100;   //speed of snake

  final int x[] = new int[GAME_UNITS]; //holds body parts of snake in x-coordinates
  ...
  if(running){
    /*//helps to visualize objects in the screen
